...
# ১। এক নজরে ক্ষিপ্র কম্পোজিশনাল লেআউট
...
2. পৃথায়ক ব্যবহার করে লেখাকে ছিন্নায়িত বা অংশায়িত করা যায়। এটা IME কে ধরে নিতে বাধ্য করবে যে পৃথায়কের আগে আর পরে আলাদা আলাদা অংশ লেখা হয়েছে। যেমন:  
`jh` = `ঝ` &emsp; `j;h` = `জহ`  
`ae` = `অ্যা` &emsp; `a;e` = `আএ`  
`ii` = `ঈ` &emsp; `i;i` = `ইই`  
`ka` = `কা` &emsp; `k;a` = `কআ`
...
ক্ষিপ্রতে একাধিক মডিফায়ার রয়েছে। একটি হলো `f` যাকে `⁌` রূপে দেখানো হয় লেখার সময় এবং অপরটি **স্লাইসার**।
